...
let DonorDonationsPageModule = class DonorDonationsPageModule {
};
...
let DonorDonationsPage = class DonorDonationsPage {
    constructor(utils, router, storage, authService, service, http) {
        this.utils = utils;
        this.router = router;
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.http.get(`${this.service.homeUrl}/donations/find-by-id?id=${this.user.id}&user=donor`, { observe: 'response' }).subscribe(response => {
    ...
    openChat(donorFirst, donorLast, ngoFirstname, ngoLastname) {
...
DonorDonationsPage.ctorParameters = () => [
...
//# sourceMappingURL=donner-donor-donations-donor-donations-module-es2015.js.map