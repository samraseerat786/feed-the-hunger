...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(utils, router, storage, service, http, db) {
        this.utils = utils;
        this.router = router;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.http.get(this.service.homeUrl + "/reviews/findByDonner/" + id, { observe: 'response' }).subscribe(function (response) {
    ...
    ProfilePage.prototype.expandCLick = function () {
    ...
    ProfilePage.prototype.imageFileChanged = function (e) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var filePath, storageRef;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.profileImage = e.target.files[0];
                        filePath = "profile-images/" + this.user.user.user_name + ".png";
                        storageRef = this.db.ref(filePath);
                        debugger;
                        return [4 /*yield*/, this.utils.presentLoading("Please wait...")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.db.upload(filePath, this.profileImage).then(function (snapshot) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                var _this = this;
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, storageRef.getDownloadURL().subscribe(function (downloadURL) {
                                                ...
                                                var userObject = {};
                                                if (_this.user.user) {
                                                    userObject = _this.user.user;
                                                    _this.user.user.image = downloadURL;
                                                }
                                                else {
                                                    userObject = _this.user;
                                                    _this.user.image = downloadURL;
                                                }
                                                localStorage.setItem("user", JSON.stringify(_this.user));
                                                _this.saveHttpReq(userObject);
                                            })];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
    ...
    ProfilePage.prototype.saveHttpReq = function (dataObj) {
        var _this = this;
        var url = this.service.homeUrl + "/users/updateUser";
        this.http.put(url, dataObj).subscribe(function (data) {
            _this.utils.stopLoading();
        }, function (error) {
            _this.utils.stopLoading();
            console.log('error', error);
...
//# sourceMappingURL=shared-profile-profile-module-es5.js.map