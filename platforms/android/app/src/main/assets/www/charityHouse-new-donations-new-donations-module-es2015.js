...
let NewDonationsPageModule = class NewDonationsPageModule {
};
...
let NewDonationsPage = class NewDonationsPage {
    constructor(utils, router, storage, authService, service, http, alertCtrl) {
        this.utils = utils;
        this.router = router;
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.http.get(`${this.service.homeUrl}/donations/find-by-id?id=${this.user.id}&user=ngo`, { observe: 'response' }).subscribe(response => {
                ...
                buttons: [
                    {
                        ...
                        handler: (data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                            ...
                            if (data.date == '') {
                                yield this.utils.presentAlert("Please select food picking time.");
                                return;
                            }
    ...
    acceptOrRejectDonation(id, status, time) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield yield this.utils.presentLoading("Please wait...");
            let date = new Date();
            ...
            this.http.get(`${this.service.homeUrl}/donations/update-donation-by-id?id=${id}&status=${status}&time=${acceptanceDate}`, { observe: 'response' }).subscribe(response => {
                this.utils.stopLoading();
                if (response.status === 200 || response.status === 201) {
                    console.log(response.body);
                    if (response.body) {
...
NewDonationsPage.ctorParameters = () => [
...
//# sourceMappingURL=charityHouse-new-donations-new-donations-module-es2015.js.map