...
var AdminProfilePage = /** @class */ (function () {
    function AdminProfilePage(utils, route, router, http, service, db) {
        this.utils = utils;
        this.route = route;
        this.router = router;
        this.http = http;
        ...
        this.route.paramMap.subscribe(function (paramMap) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        val = paramMap.get('id');
                        url = this.service.homeUrl + "/users/getUser/" + val;
    ...
    AdminProfilePage.prototype.imageFileChanged = function (e) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var filePath, storageRef, fileName;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.profileImage = e.target.files[0];
                        filePath = "profile-images/" + this.user.user_name + ".png";
    ...
    AdminProfilePage.prototype.saveHttpReq = function (dataObj) {
        var _this = this;
