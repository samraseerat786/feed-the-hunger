...
var UpdatePage = /** @class */ (function () {
    function UpdatePage(utils, route, http, router, service, formBuilder) {
        this.utils = utils;
        this.route = route;
        this.http = http;
        this.router = router;
    ...
    UpdatePage.prototype.generateUser = function () {
    ...
    UpdatePage.prototype.updateData = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.signupForm.valid) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        this.saveHttpReq(this.generateUser()).subscribe(function (data) {
                            _this.utils.stopLoading();
                            _this.utils.presentToast('User updated successfully');
                            _this.router.navigate(['tabs/donners']);
                        }, function (error) {
                            _this.utils.stopLoading();
    ...
    UpdatePage.prototype.saveHttpReq = function (dataObj) {
        var url = this.service.homeUrl + "/donners/updateDonner";
