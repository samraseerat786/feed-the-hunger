...
var LoginPage = /** @class */ (function () {
    function LoginPage(utils, route, http, formBuilder, service, router) {
        this.utils = utils;
        this.route = route;
        this.http = http;
                    ...
                    case 1:
                        ...
                        this.saveHttpReq(loginData).subscribe(function (d) {
                            ...
                            if (d.emailStatus && d.loginStatus && d.applicationStatus === 'approved' && d.role != null) {
                                ...
                                _this.utils.presentAlert('Application status is disapproved. ' +
                                    'Please check your email and click the activation link in email. Thank you!');
                            }
                            else if (d.emailStatus || d.loginStatus) {
                                _this.utils.presentAlert('Invalid Email, password. Try again latter !');
                            }
                            else if (d.emailStatus === false) {
                                _this.utils.presentAlert('Sorry ! User with that email, password does not exist');
                            }
                        }, function (error) {
                            _this.utils.stopLoading();
                            _this.utils.presentAlert(':( OOPS ! Server Error. Confirm your internet connection.');
