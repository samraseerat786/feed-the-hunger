...
var SettingPage = /** @class */ (function () {
    function SettingPage(router) {
        this.router = router;
    }
    SettingPage.prototype.ngOnInit = function () {
    };
    SettingPage.prototype.manageNotification = function () {
    };
    SettingPage.prototype.helpUser = function () {
