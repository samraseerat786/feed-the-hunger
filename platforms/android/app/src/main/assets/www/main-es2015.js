...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                loadChildren: () => __webpack_require__.e(/*! import() | admin-list-list-module */ "admin-list-list-module").then(__webpack_require__.bind(null, /*! ./admin/list/list.module */ "./src/app/admin/list/list.module.ts")).then(m => m.ListPageModule)
            },
            {
                path: ':id',
                loadChildren: () => __webpack_require__.e(/*! import() | admin-detail-detail-module */ "admin-detail-detail-module").then(__webpack_require__.bind(null, /*! ./admin/detail/detail.module */ "./src/app/admin/detail/detail.module.ts")).then(m => m.DetailPageModule)
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                loadChildren: () => __webpack_require__.e(/*! import() | donner-charity-list-charity-list-module */ "donner-charity-list-charity-list-module").then(__webpack_require__.bind(null, /*! ./donner/charity-list/charity-list.module */ "./src/app/donner/charity-list/charity-list.module.ts")).then(m => m.CharityListPageModule)
            },
            {
                path: ':id',
                loadChildren: () => __webpack_require__.e(/*! import() | donner-donate-fund-donate-fund-module */ "donner-donate-fund-donate-fund-module").then(__webpack_require__.bind(null, /*! ./donner/donate-fund/donate-fund.module */ "./src/app/donner/donate-fund/donate-fund.module.ts")).then(m => m.DonateFundPageModule)
            }
        ]
    },
    {
        path: 'addUser',
        loadChildren: () => __webpack_require__.e(/*! import() | admin-addUser-addUser-module */ "admin-addUser-addUser-module").then(__webpack_require__.bind(null, /*! ./admin/addUser/addUser.module */ "./src/app/admin/addUser/addUser.module.ts")).then(m => m.AddUserPageModule)
    },
    {
        path: 'setting',
...
let AppComponent = class AppComponent {
    constructor(alertCtrl, utils, platform, router, splashScreen, service, statusBar, authService, navCtrl) {
