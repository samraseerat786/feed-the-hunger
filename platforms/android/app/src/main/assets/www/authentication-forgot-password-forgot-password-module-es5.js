...
var ForgotPasswordPage = /** @class */ (function () {
    function ForgotPasswordPage(utils, route, http, formBuilder, service, router) {
        this.utils = utils;
        this.route = route;
        this.http = http;
    ...
    ForgotPasswordPage.prototype.formInitializer = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        passwordData = this.forgotPasswordForm.value;
                        return [4 /*yield*/, this.utils.presentLoading("Please wait...")];
                    case 1:
                        _a.sent();
                        this.sendRequest(passwordData).subscribe(function (d) {
                            _this.utils.stopLoading();
                            _this.utils.presentToast('Password is successfully updated.');
                            _this.router.navigate(['']);
                        }, function (error) {
                            _this.utils.stopLoading();
                            _this.utils.presentAlert(':( OOPS ! Server Error.');
    ...
    ForgotPasswordPage.prototype.sendRequest = function (dataObj) {
        var url = this.service.homeUrl + "/users/updatePassword";
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        test = this.forgotPasswordForm.value;
                        item = test.email;
                        ...
                        this.http.get(this.service.homeUrl + "/users/email/" + item, { observe: 'response' }).subscribe(function (response) {
                            ...
                            if (response.status === 200 || response.status === 201) {
                                ...
                                if (tester.toString() === 'true') {
                                    _this.utils.presentAlert('Email does not exist. Try with another email!');
                                }
...
//# sourceMappingURL=authentication-forgot-password-forgot-password-module-es5.js.map