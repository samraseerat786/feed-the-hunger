...
var CharityHouseChatPageModule = /** @class */ (function () {
    function CharityHouseChatPageModule() {
    }
    ...
    return CharityHouseChatPageModule;
}());
...
var CharityHouseChatPage = /** @class */ (function () {
    function CharityHouseChatPage(utils, route, http, service, db) {
        this.utils = utils;
        this.route = route;
        this.http = http;
    ...
    CharityHouseChatPage.prototype.ngOnInit = function () {
    };
    CharityHouseChatPage.prototype.loadData = function () {
    ...
    CharityHouseChatPage.prototype.loadchannelName = function () {
        var donner = JSON.parse(localStorage.getItem('donnerName'));
    ...
    CharityHouseChatPage.prototype.sendMessage = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.service.homeUrl + "/channels/exist-or-not/" + this.channel;
    ...
    CharityHouseChatPage.ctorParameters = function () { return [
...
//# sourceMappingURL=charityHouse-charity-house-chat-charity-house-chat-module-es5.js.map