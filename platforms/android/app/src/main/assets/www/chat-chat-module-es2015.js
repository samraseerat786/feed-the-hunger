...
/***/ "./node_modules/@angular/fire/analytics/es2015/analytics.js":
/*!******************************************************************!*\
  !*** ./node_modules/@angular/fire/analytics/es2015/analytics.js ***!
  \******************************************************************/
...
;
const COLLECTION_ENABLED = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('angularfire2.analytics.analyticsCollectionEnabled');
const APP_VERSION = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('angularfire2.analytics.appVersion');
const APP_NAME = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('angularfire2.analytics.appName');
const DEBUG_MODE = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('angularfire2.analytics.debugMode');
const CONFIG = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('angularfire2.analytics.config');
...
let AngularFireAnalytics = class AngularFireAnalytics {
    constructor(options, nameOrConfig, analyticsCollectionEnabled, providedAppVersion, providedAppName, debugModeEnabled, providedConfig, platformId, zone) {
        ...
        const analytics = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(undefined).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["observeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => __webpack_require__.e(/*! import() | firebase-analytics */ "firebase-analytics").then(__webpack_require__.bind(null, /*! firebase/analytics */ "./node_modules/firebase/analytics/dist/index.esm.js"))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(() => Object(_angular_fire__WEBPACK_IMPORTED_MODULE_4__["_firebaseAppFactory"])(options, zone, nameOrConfig)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(app => app.analytics()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(analytics => {
...
/***/ "./node_modules/@angular/fire/analytics/es2015/analytics.module.js":
/*!*************************************************************************!*\
  !*** ./node_modules/@angular/fire/analytics/es2015/analytics.module.js ***!
  \*************************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _analytics_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./analytics.service */ "./node_modules/@angular/fire/analytics/es2015/analytics.service.js");
/* harmony import */ var _analytics__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./analytics */ "./node_modules/@angular/fire/analytics/es2015/analytics.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "./node_modules/@angular/fire/analytics/es2015/analytics.service.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@angular/fire/analytics/es2015/analytics.service.js ***!
  \**************************************************************************/
...
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/fire */ "./node_modules/@angular/fire/es2015/index.js");
/* harmony import */ var _analytics__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./analytics */ "./node_modules/@angular/fire/analytics/es2015/analytics.js");
...
let ScreenTrackingService = class ScreenTrackingService {
    constructor(analytics, router, title, componentFactoryResolver, platformId, debugModeEnabled, zone, injector) {
        ...
        zone.runOutsideAngular(() => {
            const activationEndEvents = router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(e => e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivationEnd"]));
            const navigationEndEvents = router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(e => e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]));
            this.disposable = navigationEndEvents.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["withLatestFrom"])(activationEndEvents), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(([navigationEnd, activationEnd]) => {
                ...
                if (typeof loadChildren === "string") {
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(Object.assign({}, params, { [SCREEN_CLASS_KEY]: loadChildren.split('#')[1] }));
                }
                else if (typeof component === 'string') {
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(Object.assign({}, params, { [SCREEN_CLASS_KEY]: component }));
                }
                else if (component) {
                    const componentFactory = componentFactoryResolver.resolveComponentFactory(component);
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(Object.assign({}, params, { [SCREEN_CLASS_KEY]: componentFactory.selector }));
                }
                    ...
                    return loadedChildren$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(lazyModule => {
                        if (lazyModule instanceof _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModuleFactory"]) {
                            ...
                            const routes = moduleRef.injector.get(_angular_router__WEBPACK_IMPORTED_MODULE_3__["ROUTES"]);
                    ...
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(Object.assign({}, params, { [SCREEN_CLASS_KEY]: DEFAULT_SCREEN_CLASS }));
                }
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(params => (Object.assign({ [FIREBASE_SCREEN_CLASS_KEY]: params[SCREEN_CLASS_KEY], [FIREBASE_SCREEN_INSTANCE_ID_KEY]: getScreenInstanceID(params) }, params))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(params => {
            ...
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["groupBy"])(params => params[OUTLET_KEY]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["mergeMap"])(group => group.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(undefined), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["pairwise"])())), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(([prior, current]) => prior ? Object.assign({ [FIREBASE_PREVIOUS_SCREEN_CLASS_KEY]: prior[SCREEN_CLASS_KEY], [FIREBASE_PREVIOUS_SCREEN_NAME_KEY]: prior[SCREEN_NAME_KEY], [FIREBASE_PREVIOUS_SCREEN_INSTANCE_ID_KEY]: prior[FIREBASE_SCREEN_INSTANCE_ID_KEY] }, current) : current), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(params => debugModeEnabled && console.info(SCREEN_VIEW_EVENT, params)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(params => zone.runOutsideAngular(() => analytics.logEvent(SCREEN_VIEW_EVENT, params)))).subscribe();
        });
    }
    ngOnDestroy() {
        if (this.disposable) {
...
let UserTrackingService = class UserTrackingService {
    constructor(analytics, zone, platformId) {
        ...
        if (!Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["isPlatformServer"])(platformId)) {
            zone.runOutsideAngular(() => {
                this.disposable = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(__webpack_require__.e(/*! import() | firebase-auth */ "firebase-auth").then(__webpack_require__.bind(null, /*! firebase/auth */ "./node_modules/firebase/auth/dist/index.esm.js"))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["observeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(() => analytics.app), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(app => app.auth()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(auth => new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](auth.onAuthStateChanged.bind(auth))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(user => analytics.setUserId(user ? user.uid : null))).subscribe();
            });
        }
    }
    ngOnDestroy() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _public_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./public_api */ "./node_modules/@angular/fire/analytics/es2015/public_api.js");
...
/***/ "./node_modules/@angular/fire/analytics/es2015/public_api.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@angular/fire/analytics/es2015/public_api.js ***!
  \*******************************************************************/
/*! exports provided: COLLECTION_ENABLED, APP_VERSION, APP_NAME, DEBUG_MODE, CONFIG, AngularFireAnalytics, AngularFireAnalyticsModule, ScreenTrackingService, UserTrackingService, ɵ0 */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _analytics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./analytics */ "./node_modules/@angular/fire/analytics/es2015/analytics.js");
...
/* harmony import */ var _analytics_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./analytics.module */ "./node_modules/@angular/fire/analytics/es2015/analytics.module.js");
...
/* harmony import */ var _analytics_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./analytics.service */ "./node_modules/@angular/fire/analytics/es2015/analytics.service.js");
...
/* harmony import */ var _angular_fire_analytics__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/fire/analytics */ "./node_modules/@angular/fire/analytics/es2015/index.js");
...
let ChatPage = class ChatPage {
    constructor(utils, db, route, firestore) {
        this.utils = utils;
        this.db = db;
        this.route = route;
