...
var UpdateCharityHousePageModule = /** @class */ (function () {
    function UpdateCharityHousePageModule() {
    }
    ...
    return UpdateCharityHousePageModule;
}());
...
var UpdateCharityHousePage = /** @class */ (function () {
    function UpdateCharityHousePage(router, http, service, formBuilder) {
        this.router = router;
        this.http = http;
        this.service = service;
        this.formBuilder = formBuilder;
    }
    UpdateCharityHousePage.prototype.ngOnInit = function () {
    };
    UpdateCharityHousePage.prototype.userFormInitializer = function () {
    ...
    UpdateCharityHousePage.prototype.charityFormInitializer = function () {
        var EMAILPATTERN = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i;
    ...
    UpdateCharityHousePage.prototype.addressFormInitializer = function () {
    ...
    UpdateCharityHousePage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-update-charity-house-update-charity-house-module-es5.js.map